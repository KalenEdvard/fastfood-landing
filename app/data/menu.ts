...
export const menuCategories: MenuCategory[] = [
  {
    ...
    items: [
      { name: 'Острый бургер', description: 'булочка, котлета, маринованный огурец, помидор, айсберг, соус острый, майонез', price: 180, image: 'https://images.unsplash.com/photo-1553979459-d2229ba7433b?w=400&h=260&fit=crop' },
      { name: 'Бургер американец', price: 200, image: 'https://images.unsplash.com/photo-1594212699903-ec8a3eca50f5?w=400&h=260&fit=crop' },
      { name: 'Бургер мексиканец', price: 200, image: 'https://images.unsplash.com/photo-1561758033-d89a9ad46330?w=400&h=260&fit=crop' },
      { name: 'Бургер британец', price: 200, image: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400&h=260&fit=crop' },
      { name: 'Чизбургер', description: 'булочка, котлета, помидор, маринованный огурец, салат, сыр пармезан, чесночный соус, кетчуп', price: 170, image: 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?w=400&h=260&fit=crop' },
      { name: 'Гамбургер', description: 'булочка, котлета, помидор, маринованный огурец, салат, кетчуп, чесночный соус', price: 160, image: 'https://images.unsplash.com/photo-1586816001966-79b736744398?w=400&h=260&fit=crop' },
      { name: 'Чиккен бургер', description: 'булочка, курица в панировке, огурец, помидор, салат, кетчуп, чесночный соус', price: 175, image: 'https://images.unsplash.com/photo-1606755962773-d324e0a13086?w=400&h=260&fit=crop' },
      { name: 'Бургер тар-тар', description: 'булочка, курица в панировке, айсберг, помидор, маринованный огурец, соус тар-тар, кетчуп', price: 185, image: 'https://images.unsplash.com/photo-1550547660-d9450f859349?w=400&h=260&fit=crop' },
    ],
  },
  {
    id: 'shawarma',
    ...
    items: [
      { name: 'Шаурма в пите', description: 'лепёшка пите, мясо говядины, мясо куриный, огурец, помидор, картошка, фри, чесночный соус, кетчуп', price: 200, image: 'https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?w=400&h=260&fit=crop' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Хот-дог', description: 'бутерброд, огурец, свежий огурец, огурец маринованный, кетчуп, майонез, сосиска халол', price: 120, image: 'https://images.unsplash.com/photo-1612392062631-94b5b5b8c5b1?w=400&h=260&fit=crop' },
      { name: 'Ролл цезарь', description: 'курица в панировке, салат, ломтик помидора, огурец, соус цезарь, сыр пармезан', price: 175, image: 'https://images.unsplash.com/photo-1540420773420-3366772f4999?w=400&h=260&fit=crop' },
    ],
  },
  {
    id: 'pizza',
  ...
  },
  {
    ...
    items: [
      { name: 'Филадельфия', price: 350, image: 'https://images.unsplash.com/photo-1617196034183-421b4040ed20?w=400&h=260&fit=crop' },
      { name: 'Опалённый филадельфия', price: 380, image: 'https://images.unsplash.com/photo-1617196034099-58b4f3b9b7e3?w=400&h=260&fit=crop' },
      { name: 'Хоккайдо', price: 320, image: 'https://images.unsplash.com/photo-1579584425555-c3ce17fd4351?w=400&h=260&fit=crop' },
      { name: 'Сырный', price: 300, image: 'https://images.unsplash.com/photo-1559410545-0bdcd187e0a6?w=400&h=260&fit=crop' },
      { name: 'Калифорния', price: 300, image: 'https://images.unsplash.com/photo-1562802378-063ec186a863?w=400&h=260&fit=crop' },
      { name: 'Инь-Янь', price: 320, image: 'https://images.unsplash.com/photo-1611143669185-af224c5e3252?w=400&h=260&fit=crop' },
      { name: 'Жареный с лососем', price: 340, image: 'https://images.unsplash.com/photo-1617196034183-421b4040ed20?w=400&h=260&fit=crop' },
      { name: 'Жареный с угрём', price: 360, image: 'https://images.unsplash.com/photo-1617196034099-58b4f3b9b7e3?w=400&h=260&fit=crop' },
      { name: 'Запечённый с лососем', price: 340, image: 'https://images.unsplash.com/photo-1617196034183-421b4040ed20?w=400&h=260&fit=crop' },
      { name: 'Запечённый с угрём', price: 360, image: 'https://images.unsplash.com/photo-1559410545-0bdcd187e0a6?w=400&h=260&fit=crop' },
      { name: 'Ролл с лососем', price: 280, image: 'https://images.unsplash.com/photo-1562802378-063ec186a863?w=400&h=260&fit=crop' },
      { name: 'Ролл с угрём', price: 300, image: 'https://images.unsplash.com/photo-1579584425555-c3ce17fd4351?w=400&h=260&fit=crop' },
      { name: 'Ролл с курицей', price: 260, image: 'https://images.unsplash.com/photo-1611143669185-af224c5e3252?w=400&h=260&fit=crop' },
      { name: 'Ролл с овощами', price: 220, image: 'https://images.unsplash.com/photo-1562802378-063ec186a863?w=400&h=260&fit=crop' },
    ],
  },
  {
    id: 'fryer',
    ...
    items: [
      ...
      { name: 'Сырные палочки', price: 160, image: 'https://images.unsplash.com/photo-1541592106381-b31e9677c0e5?w=400&h=260&fit=crop' },
  ...
  },
  {
    ...
    items: [
      { name: 'Стейк филе', description: 'жареный курица, салатный лист, огурец, помидор, лимон, чесночный соус', price: 280, image: 'https://images.unsplash.com/photo-1546833999-b9f581a1996d?w=400&h=260&fit=crop' },
