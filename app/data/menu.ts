...
export const menuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      { name: 'Черный чай', price: 20, image: 'https://images.unsplash.com/photo-1576092768241-dec231879fc3?w=400&h=260&fit=crop' },
      { name: 'Зелёный чай', price: 20, image: '/images/drink-green-tea.jpg' },
      { name: 'С лимоном', price: 50, image: 'https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=400&h=260&fit=crop' },
      { name: 'С наватом', price: 30, image: 'https://images.unsplash.com/photo-1564890369478-c89ca6d9cde9?w=400&h=260&fit=crop' },
      { name: 'Каркаде чай', price: 90, image: 'https://images.unsplash.com/photo-1615485500704-8e990f9900f7?w=400&h=260&fit=crop' },
      ...
      { name: 'Fanta', price: 70, image: '/images/drink-fanta.png', variants: [{ label: '0.5 л', price: 70 }, { label: '1 л', price: 100 }, { label: '1.5 л', price: 160 }, { label: '2 л', price: 200 }] },
      { name: 'Fuse tea', description: 'ананас, манго, ромашка, персик', price: 70, image: '/images/drink-fusetea.png', variants: [{ label: '0.5 л', price: 70 }, { label: '1 л', price: 100 }] },
      { name: 'Piko', description: 'смородина, апельсин', price: 85, image: '/images/drink-piko.png', variants: [{ label: '0.5 л', price: 85 }, { label: '1 л', price: 150 }] },
      { name: 'Piko мини', price: 50, image: '/images/drink-piko.png' },
      { name: 'Flavis', description: 'гранат, груша, мохито, голубика, клубника', price: 85, image: '/images/drink-flavis.png', variants: [{ label: '0.5 л', price: 85 }, { label: '1.25 л', price: 150 }] },
